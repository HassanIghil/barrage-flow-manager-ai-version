...
class Repartition(Base):
    ...
    id_lacher = Column(Integer, ForeignKey("Lacher_Eau.id_lacher", ondelete="CASCADE"), nullable=False)
    id_coop = Column(Integer, ForeignKey("Cooperative.id_coop", ondelete="CASCADE"), nullable=False)
    ...
    __table_args__ = (UniqueConstraint('id_lacher', 'id_coop', name='unique_lacher_coop'),)
