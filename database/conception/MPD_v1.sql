-- SCHEMA CONCEPTION / DESIGN DOCUMENT
-- -----------------------------------------------------
-- This file is intended for schema design documentation only.
-- Do NOT mount or execute this file via Docker initialization.
-- The executable schema should live under ./database/sql
-- (e.g., database/sql/01_schema.sql) and be used by
-- /docker-entrypoint-initdb.d during container startup.
-- =====================================================
-- 1. TABLE BARRAGE
-- =====================================================
